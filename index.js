...
withdraw_click.addEventListener('click',()=>{
    ...
    //  changevalue();
      ...
      document.querySelector('.withdraw-input-amount').innerHTML+=`<p style="color:red;">Enter amount more then 100</p>`
      user_amount='';
    }else if(user_amount>withdrable.innerHTML){
      document.querySelector('.withdraw-input-amount').innerHTML+=`<p style="color:red;">insufficient balance</p>`
      user_amount='';
    }else{
